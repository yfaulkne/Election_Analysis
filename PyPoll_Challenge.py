...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in counties_votes:
        ...
        turnout_percentage = float(turnout_count) / float(total_votes) *100
        ...
        if (county_votes > turnout_count) and (county_vote_percentage > turnout_percentage):
            turnout_count = county_votes
